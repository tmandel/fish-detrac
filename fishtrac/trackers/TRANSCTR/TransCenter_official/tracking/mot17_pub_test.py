...
def get_args_parser():
    ...
    parser.add_argument('--model_path', default='./model_zoo/MOT17_coco.pth', type=str)
...
def main(tracktor):
    ...
    for model_dir, output_dir in zip(models, output_dirs):
       ...
       # else:
       #     print("Not saving results since path already exists", output_dir + "txt/" + video_name + '.txt')
