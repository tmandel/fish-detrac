...
try
    time_start = tic;
	method = [pythonPath ' dan_wrapper.py detections.mat ' num2str(numFrames) ' ' num2str(curSequence.imgWidth) ' ' num2str(curSequence.imgHeight) ' ' curSequence.imgFolder ' ' igrStr]
	disp(method)
	system(method);
	stateInfo = [];
