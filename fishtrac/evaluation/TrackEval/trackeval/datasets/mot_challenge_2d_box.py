...
class MotChallenge2DBox(_BaseDataset):
        ...
        for seq in self.seq_list:
            ...
            if not self.data_is_zipped:
                ...
                if not os.path.isfile(curr_file):
                    ...
                    sys.exit()
                    raise TrackEvalException('GT file not found for sequence: ' + curr_file)
        ...
        for tracker in self.tracker_list:
            if self.data_is_zipped:
                ...
                for seq in self.seq_list:
                    ...
                    curr_file = os.path.join(self.tracker_fol, seq, 'tracker.txt')
    ...
    def _load_raw_file(self, tracker, seq, is_gt):
        ...
        if self.data_is_zipped:
            ...
            if is_gt:
                ...
                file = os.path.join(self.tracker_fol, self.tracker_sub_fol, seq, 'tracker.txt')
    ...
    def _calculate_similarities(self, gt_dets_t, tracker_dets_t):
        ...
        similarity_scores = self._calculate_box_dious(gt_dets_t, tracker_dets_t, box_format='xywh')
