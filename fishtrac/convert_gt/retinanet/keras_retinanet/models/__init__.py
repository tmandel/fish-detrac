...
def convert_model(prediction_model=None, model=None, nms=True, class_specific_filter=True, anchor_params=None,
                  detector=None, nms_threshold=0.2):
    ...
    return retinanet_bbox(prediction_model=prediction_model, model=model, nms=nms,
                          class_specific_filter=class_specific_filter, anchor_params=anchor_params,
                          detector=detector, nms_threshold=nms_threshold)  # memory leak here
